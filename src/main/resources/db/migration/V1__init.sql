...
(
    ...
    unique uniq_collection_to_colour (collection_id, colour_id)
...
insert into colour(name, type, pigments, lightfast, staining, granulation, grade, confirmedASTM, approved, opacity, binder, image, brand_id) values
                ...
                ('French ultramarine', 'Watercolour', 'pb29', 'Excellent', 'Not staining', true, 'Professional', true, true, 'Transperent', 'Gumarabic', '/img/colour2.jpg', 2),
                ...
                ('Dioxazine violet', 'Watercolour', 'pv23', 'Bad', 'Staining', false, 'Professional', true, false, 'Transperent', null, '/img/colour9.jpg', 2),
                ('Quinacridone gold', 'Watercolour', 'po49', 'Excellent', '2', false, 'Professional', false, true, 'Transperent', 'Gumarabic', null, 1);
